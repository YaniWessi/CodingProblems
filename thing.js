    ...
    <header className="bg-gray-800 py-4 px-6 text-white">
          ...
          <div className="mr-4">
            ...
            >
              ...
              <div className="hidden md:block">
                <input
                  type="text"
                  className="bg-gray-700 rounded-full py-2 px-4 text-sm text-gray-200 focus:outline-none focus:bg-gray-600"
                  placeholder="Search"
                />
              </div>
      ...
      {isMobileMenuOpen && (
        <div className="mt-2 md:hidden">
          <input
            type="text"
            className="bg-gray-700 rounded-full py-2 px-4 text-sm text-gray-200 w-full focus:outline-none focus:bg-gray-600"
            placeholder="Search"
          />
        </div>
      )}
